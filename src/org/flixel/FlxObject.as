package org.flixel
{
	...
	public class FlxObject extends FlxRect
	{
		 ...
		 * FlxState is adding this FlxTimer to FlxG's timer group to automate updating.
		 * 
		 * @param	Timer		The <code>FlxTimer</code> you want to add.
		 * 
		 * @return	The same <code>FlxTimer</code> that was passed in.
		 */
		public function addTimer(Timer:FlxTimer):FlxTimer /* <<CUSTOM CODE>> */
		{
		 ...
		 * FlxState is removing this FlxTimer from FlxG's timer group.
		 * 
		 * @param	Timer		The <code>FlxTimer</code> you want to remove.
		 * 
		 * @return	The removed <code>FlxTimer</code>.
		 */
		public function removeTimer(Timer:FlxTimer):FlxTimer /* <<CUSTOM CODE>> */
		{
