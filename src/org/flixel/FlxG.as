package org.flixel
{
	...
	public class FlxG
	{
		 ...
		 */
		static protected var timerGroup:/*FlxTimer*/Array = [];
		...
		{
			var index:int = timerGroup.indexOf(Timer);
			if (index < 0 || index >= timerGroup.length)
				return null;
		...
		{
			var currentTimerGroup:/*FlxTimer*/Array = timerGroup.slice();
			for each (var t:FlxTimer in currentTimerGroup)
				t.update();
		}
	}
}
